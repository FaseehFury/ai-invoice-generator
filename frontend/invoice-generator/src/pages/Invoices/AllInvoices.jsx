...
const AllInvoices = () => {
  ...
  if (loading) {
    return (
      <div className="flex justify-center w-8 h-8 animate-spin text-blue-600">
        <Loader2 className="" />
      </div>
    );
  }
        ...
        <div className="p-4 sm:p-6 border-b border-slate-200">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-shrink-0">
              <select
                className="w-ful sm:w-auto h-10 px-3 py-2 border border-slate-200 rounded-lg bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
                value={statusFilter}
