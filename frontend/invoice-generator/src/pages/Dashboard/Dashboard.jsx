import { DollarSign, FileText, Loader, Loader2, Plus } from "lucide-react";
...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Recent Inovices */}
      <div className="w-full border border-slate-200 rounded-lg shadow-sm shadow-gray-100 overflow-hidden">
        ...
        {recentInvoices.length > 0 ? (
          <div className="w-[90vw] md:w-auto overflow-auto">
