...
const Hero = () => {
  ...
  return (
    <section className="relative bg-[#fbfbfb] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-screen-7xl px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold text-blue-950 leading-tight mb-6">
          ...
          <p className="text-base sm:text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
            ...
            reminders, and provide start insights to help you manage your
            financials.
          </p>
