  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all ${
        isScrolled ? "bg-white/95 black-blur-sm shadow-lg" : "bg-white/0"
      }`}
    >
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="lg:hidden">
            <button
              className="p-2 rounded-lg text-gray-600 hover:text-gray-100 transition-colors duration-200"
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {isAuthenticated ? (
              ...
              <>
                <Link
                  to="/login"
                  className="block px-4 py-4 text-gray-600 hover:text-gray-900 hover:bg-gray-50 font-medium transition-colors duration-200"
                >
                  Login
                </Link>
                <Link
